...
terraform apply -target=helm_release.chaos_mesh -target=helm_release.kyverno -target=helm_release.argo_rollouts -target=helm_release.argocd -target=helm_release.kube_prometheus_stack -target=helm_release.linkerd_crds -target=helm_release.vault -target=helm_release.trivy -auto-approve
